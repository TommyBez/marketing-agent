...
This subsystem measures real AI Gateway spend before paid plans are introduced. It deliberately does not implement subscriptions, Dodo Payments, top-ups, pricing UI, pilot cohorts, or pilot expiry automation, and it does not track infrastructure cost (Sandbox, Workflow, Functions, Queues, or Vercel FOCUS billing).
...
- Only model spend consumes the balance.
...
3. Let the 02:15 UTC reconciliation run twice and inspect `cost_reconciliation_runs`, source warnings, and Gateway residual adjustments.
